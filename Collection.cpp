...
/*
Description: The default constructor for this class will create a collection that contains three exhibits and will create three animal prototypes to be used to get information about the animal type without the user having to own one.
*/
...
/*
Description: Returns the number of animals in the collection, regardless of their type.
*/
...
/*
Description: Returns the total cost of feeding all the animals in the collection
*/
...
/*
Description: addExhibit adds another exhibit to the collection. If the collection array is too small to hold all the exhibits, call resizeArray() to expand the array
*/
...
/*
Description: resizeArray is a helper function that will expand the size of the collect array. It doubles the capacity.
*/
...
/*
Description: acquireAnimal allows the user to purchase another animal. It takes the age of the desired animal (3 for adults, 0 for babies) and the index that indicates which exhibit the new animal will be in.
*/
...
/*
Description: animalsAge allows the user to increment the ages of all the animals in the collection
*/
...
/*
Description: animalDies simulates an event where an animal is chosen randomly from the collection to get sick and die. It is very sad.
*/
...
/*
Description: animalBirth chooses an adult animal at random to give birth. It adds a litter of their babies to the appropriate exhibit
*/
...
/*
Description: animalPayoff returns the sum of the daily payoff values of all animals in the collection
*/
...
/*
Description: animalName returns the name of the animal in the exhibit represented by the index in the collection
*/
...
/*
Description: showCollection prints a list of all animals in the collection, sorted by exhibit. This was primarily used for debugging applications.
*/
...
/*
Description: getPrototype returns the animal found in index index of the prototype array.
*/
