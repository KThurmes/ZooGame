...
/*
Description: Animal.hpp describes a parent class of animals. The homework assignment constrained the data members to a very specific set. This class represents a generic animal that can be found at the zoo and child classes represent the different species. 
